"""
Django settings for course01 project.
...
WSGI_APPLICATION = 'course01.wsgi.application'
...
ACCOUNT_USERNAME_BLACKLIST = ["admin", "administrator", "moderator", "sofokl"]
